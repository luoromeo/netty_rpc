...
public class RpcSystemConfig {
    ...
    public static final int SYSTEM_PROPERTY_CLIENT_RECONNECT_DELAY = Integer.parseInt(System.getProperty("nettyrpc.default.client.reconnect.delay",
            "10"));
    ...
    public static final String RPC_COMPILER_SPI_ATTR = "com.luoromeo.rpc.compiler.AccessAdaptive";

    public static final String RPC_ABILITY_DETAIL_SPI_ATTR = "com.luoromeo.rpc.core.AbilityDetail";
